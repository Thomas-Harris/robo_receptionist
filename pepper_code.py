...
assistant = watson_developer_cloud.AssistantV1(
    username='8b2814f4-85fb-4de3-a60d-90a3278c999e',
    password='2zzt1nIXc64k',
    version='2018-07-10'
)

# ----------> Connect to Watson Speech to Text <-------------
speech_to_text = SpeechToTextV1(
    username='f677e2a3-c910-4d33-baa9-ebdfe395b2c7',
    password='5SchiDPTMpHf',
...
def create_intent(intent_name, intent_examples):
    response = assistant.create_intent(
        workspace_id = '01f961b2-5418-498a-b0ba-4461290c4ced',
        intent = intent_name,
...
#--------> Copy Image File <-----------
def Copy_Image():
    os.system('"C:\Program Files (x86)\PuTTY\pscp" -pw Be9utiful E:\Pepper_Code_Final\image1.jpg nao@155.245.22.39:/var/persistent/home/nao/.local/share/PackageManager/apps')
